...
function countUsage(events) {
  ...
  const rows = Object.fromEntries(
    BOOTHS.map(booth => [booth.id, { week: 0, month: 0, year: 0 }])
  );
  ...
  panel.innerHTML = `
    <div class="booth-usage-head">
      <div>
        ...
        <h2>📸 Utilisation des bornes</h2>
        <p class="muted">Nombre de prestations réservées avec chaque borne.</p>
      </div>
